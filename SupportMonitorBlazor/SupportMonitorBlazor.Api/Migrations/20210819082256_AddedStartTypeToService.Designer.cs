...
namespace SupportMonitorBlazor.Api.Migrations
{
    ...
    [Migration("20210819082256_AddedStartTypeToService")]
    partial class AddedStartTypeToService
    {
            ...
            modelBuilder.Entity("SupportMonitorBlazor.Models.TMS_Services", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DisplayName = "Test",
                            Name = "Test",
                            RunningSince = new DateTime(2021, 8, 19, 10, 22, 54, 875, DateTimeKind.Local).AddTicks(9825),
                            TMS_Id = 2
                        });
                });
